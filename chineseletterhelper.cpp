...
extern char dataToBeSent[10];
extern char sentpack[5000];
QString brailleCode;
...
QString ChineseLetterHelper::GetPinyins(const QString &text)
{
    ...
    for (int i=0; i<text.length(); i++)
    {
        ...
        braille += brailleCode;
        braille += " ";
        pinYinToBraille(brailleCode);
        for(int i=0; i<dotNum; i++)
        {
            sentpack[sentNum] = dataToBeSent[i];
            sentNum++;
        }
        //sentpack[sentNum++] = 128;
        wordNum++;
    }
    sentpack[sentNum] = 64;
    sentpack[sentNum+1] = 0x0d;
    sentpack[sentNum+2] = 0x0a;
    qDebug()<<"wors num="<<wordNum;
    qDebug()<<"sentNum="<<sentNum;
    return pinyins;
}

void ChineseLetterHelper::pinYinToBraille(const QString &text)
{
    unsigned int j=0;
    QString gap[4];
    int dotValue=0;
   ...
   // qDebug()<<"j="<<j;
    ...
    for(unsigned int k=0; k<j+1; k++)
    {
        ...
        {
         //   qDebug()<<"     k="<<k;
           for(int m=0; m<gapK.length(); m++)
           {
           //    qDebug()<<"          m="<<m;
               QString gapKM = gapK.at(m);
         //      qDebug()<<"              s="<<gapKM.toInt(Q_NULLPTR,10);
               switch(gapKM.toInt(Q_NULLPTR,10))
               {
                   case 1:{
                       dotValue += 32;
                       break;
...
QString ChineseLetterHelper::GetPinyin(int code)
{
    ...
    case 7769:
        pinyin="CA";
        brailleCode="1345;245";
        break;
        pinyin="CAI";
        brailleCode="1345;1245";
        break;
    case 6978:
    case 7078:
    case 7218:
    ...
    case 8785:
        pinyin="CAN";
        brailleCode="1345;124";
        break;
    case 5687:
        pinyin="CANG";
        brailleCode="1345;145";
        break;
    case 6448:
    case 6878:
    case 8309:
    ...
    case 8413:
        pinyin="CHUAN";
        brailleCode="134,6;124";
        break;
    case 6675:
        pinyin="CHUANG";
        brailleCode="134,6;145";
        break;
    case 5879:
    case 7302:
    case 7319:
        pinyin="CHUI";
        brailleCode="134;6,34";
        break;
    case 6127:
    case 8040:
    case 8277:
    ...
    case 8631:
        pinyin="CUI";
         brailleCode="1345;6,34";
        break;
    case 6666:
    case 8169:
        pinyin="CUN";
        brailleCode="1345;6,1";
        break;
    case 5640:
    case 6547:
    case 7566:
    ...
    case 8558:
        pinyin="DIAN";
        brailleCode="34,5;124";
        break;
    case 7886:
    case 8585:
    case 8684:
        pinyin="DIAO";
        brailleCode="34,5;125";
        break;
    case 5976:
    case 6006:
    case 6273:
    ...
    case 7892:
        pinyin="HUA";
        brailleCode="12,6;245";
        break;
    case 8555:
        pinyin="HUAI";
        brailleCode="12,6;1245";
        break;
    case 5928:
    case 6140:
    case 6307:
    ...
    case 7558:
        pinyin="KUAI";
        brailleCode="13,6;1245";
        break;
    case 8737:
        pinyin="KUAN";
        brailleCode="13,6;124";
        break;
    case 5818:
    case 5831:
    case 5887:
    ...
    case 8639:
        pinyin="LUAN";
        brailleCode="123,6;124";
        break;
        pinyin="LǖE";
        brailleCode="123;56,24";
        break;
        pinyin="LUN";
        brailleCode="123;6,1";
        break;
    ...
    case 8504:
        pinyin="MING";
        brailleCode="246;5,15";
        break;
        pinyin="MIU";
        brailleCode="246;5,14";
        break;
    case 5851:
    case 6052:
    case 6175:
    ...
    case 8683:
        pinyin="NIAN";
        brailleCode="1234,5;124";
        break;
        pinyin="NIANG";
        brailleCode="1234,5;145";
        break;
    case 6064:
    case 7053:
    case 7569:
    ...
    case 8570:
        pinyin="NIE";
        brailleCode="1234;5,24";
        break;
        pinyin="NIN";
         brailleCode="1234;5,1";
        break;
    case 5690:
    case 6344:
    case 6924:
    case 8187:
        pinyin="NING";
         brailleCode="1234;5,15";
        break;
    case 6580:
    case 6678:
    case 7004:
        pinyin="NIU";
         brailleCode="1234;5,14";
        break;
    case 5715:
    case 6370:
        pinyin="NONG";
         brailleCode="1234;6,15";
        break;
    case 8181:
        pinyin="NOU";
         brailleCode="1234;5,14";
    ...
    case 7069:
        pinyin="NU";
         brailleCode="1234,6;12";
        break;
    case 7704:
    case 7847:
    case 8412:
        pinyin="Nǖ";
         brailleCode="1234,56;12";
        break;
        pinyin="NUAN";
         brailleCode="1234,6;124";
        break;
        pinyin="NUE";
        brailleCode="1234,56;24";
        break;
    case 5748:
    case 6289:
    case 6386:
    ...
    case 8310:
        pinyin="PIAO";
        brailleCode="236,5;125";
        break;
    case 6054:
    case 7513:
        pinyin="PIE";
        brailleCode="236;5,24";
        break;
    case 7041:
    case 6253:
    case 7016:
    ...
    case 7610:
        pinyin="SA";
        brailleCode="1245;245";
        break;
    case 6471:
        pinyin="SAI";
        brailleCode="1245;1245";
        break;
    case 6644:
    case 7507:
    case 8454:
        pinyin="SAN";
        brailleCode="1245;124";
        break;
    case 6290:
    case 7763:
    case 8210:
        pinyin="SANG";
        brailleCode="1245;145";
        break;
    case 6003:
    case 7150:
    case 7156:
    ...
    case 7988:
        pinyin="SHU";
        brailleCode="124,6;12";
        break;
    case 6407:
        pinyin="SHUA";
        brailleCode="124,6;245";
        break;
    case 8316:
        pinyin="SHUAI";
        brailleCode="124,6;1245";
        break;
    case 6737:
    case 6844:
        pinyin="SHUAN";
        brailleCode="124,6;124";
        break;
    case 7055:
        pinyin="SHUANG";
        brailleCode="124,6;145";
        break;
        pinyin="SHUI";
        brailleCode="124;6,34";
        break;
        pinyin="SHUN";
         brailleCode="124;6,1";
        break;
    ...
    case 8756:
        pinyin="TIAO";
         brailleCode="234,5;125";
        break;
    case 6138:
    case 8749:
        pinyin="TIE";
         brailleCode="234;5,24";
        break;
    case 6080:
    case 6167:
    case 7035:
    ...
    case 8509:
        pinyin="TU";
         brailleCode="234,6;12";
        break;
    case 6250:
    case 6972:
        pinyin="TUAN";
        brailleCode="234;6,124";
        break;
    case 7653:
        pinyin="TUI";
        brailleCode="234;6,34";
        break;
    case 5759:
    case 6629:
    case 7453:
    ...
    case 8770:
        ...
        break;
        pinyin="ZHUA";
         brailleCode="14,6;245";
        break;
        pinyin="ZHUAI";
           brailleCode="14,6;1245";
        break;
    case 6389:
    case 6645:
    case 8207:
    ...
    case 8758:
        pinyin="ZI";
           brailleCode="145,5;12";
        break;
    case 5744:
    case 7574:
    case 8453:
        pinyin="ZONG";
           brailleCode="145;6,15";
        break;
    case 5833:
    case 5878:
    case 5924:
  ...
  brailleCode="23456;245";
        ...
        {
            pinyin="FA";
            brailleCode="235;23456";
            break;
        }
        if(code>=2310 && code<=2326)
        {
            pinyin="FAN";
             brailleCode="235;1246";
            break;
        }
        if(code>=2327 && code<=2337)
        {
            pinyin="FANG";
             brailleCode="235;1345";
            break;
        }
        ...
        {
            pinyin="LA";
            brailleCode="123;2345";
            break;
        }
        if(code>=3219 && code<=3221)
        {
            pinyin="LAI";
            brailleCode="123;12456";
            break;
        }
        ...
        {
            pinyin="LUO";
            brailleCode="1236;236";
            break;
        }
        if(code>=3472 && code<=3480)
        {
            pinyin="MA";
             brailleCode="246;23456";
            break;
        }
        ...
        {
            pinyin="MAN";
             brailleCode="246;12346";
            break;
        }
        if(code>=3502 && code<=3507)
        {
            pinyin="MANG";
            brailleCode="246;1456";
            break;
        }
        ...
        {
            pinyin="XIAN";
             brailleCode="125;1234";
            break;
        }
        if(code>=4764 && code<=4783)
        {
            pinyin="XIANG";
             brailleCode="125;1345";
            break;
        }
